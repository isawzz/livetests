...
function start() {
	//test4_boa_main(); return; //test3_boa_havecode(); return;
	mAppear('dScreen', 100);
	//test1_bw_widget_boa(); return;//test0_boa_bw_fa(); return;
