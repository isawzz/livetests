...
function turn_schwein_up(b){
	...
	// 	if (list[i][0] != key[0]) {
	// 		return false; }
	// building.schwein = true;
	// ari_history_list([`${uplayer} turned the schwein up`], 'schwein');
	// ari_next_action();
}
...
function post_inspect() {
	...
	// if the building has a schwein, and schwein is closed, ari_open_rumors, followed by stage: inspect_schwein_beide
