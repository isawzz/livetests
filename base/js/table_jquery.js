...
//var myoptions = { loadingText: 'Generating Table', loadingImage: 'https://campus.mst.edu/emctest/t4_template/content_types/search_sort_table/images/loading.gif', startLine: 0, tableClass: "databaseTable_import", theadClass: "heading" };

function import_the_text(csv_text) {
	//var csvfile_import_122860 = "https://s3-us-west-2.amazonaws.com/s.cdpn.io/220427/mtcars.csv".replace(/\&amp\;/g, '&');

	$('.122860 .databaseTable_import_wrap').csv_to_table(csv_text, { loadingText: 'Generating Table', loadingImage: 'https://campus.mst.edu/emctest/t4_template/content_types/search_sort_table/images/loading.gif', startLine: 0, tableClass: "databaseTable_import", theadClass: "heading" }).bind("loadComplete", function () {
...
function make_a_table(data, options, error, obj) {
...
function get_table_html(title = 'wins / total') {
	let myhtml = `
		<span class="content_item non_wrapping">
		<span class="page_heading">
			<span>Drill down, and dig deep, with a table</span>
		</span>
		</span>
		...
		<div id="DirectEditPreserve" class="databaseTable_heading">
			<div id="DirectEditPreserve" class="databaseTable_title">${title}</div>
		...
		<div id="DirectEditPreserve" class="databaseTable">
			<div id="DirectEditPreserve" class="databaseTable_import_wrap" style="display: block"></div>
			<div id="DirectEditPreserve" class="databaseTable_UI_scrollLeft databaseTable_UI_button" style="display: none">
				<!-- JS shows/hides by appending the .hidden class -->
			</div>
			<div id="DirectEditPreserve" class="databaseTable_UI_scrollRight databaseTable_UI_button" style="display: none">
				<!-- JS shows/hides by appending the .hidden class -->
			</div>
		</div>
		</div>
...
/*********** Load csv to html table script: csvToTable.js https://code.google.com/p/jquerycsvtotable/ **************/
(function ($) {
	...
	*/
	...
	$.fn.csv_to_table = function (csv_text, options) {
		var defaults = {
			tableClass: "CSVTable",
			theadClass: "",
			thClass: "",
		...
		return this.each(function () {
			...
			make_a_table(csv_text, options, error, obj);
		});
	};
	...
	$.fn.CSVToTable = function (csvFile, options) {
		...
		return this.each(function () {
			...
			make_a_table(mystring, options, error, obj);
		});
	};
...
/*********** Table search script: filtertable.min.js https://github.com/bgrins/bindWithDelay ***********/
